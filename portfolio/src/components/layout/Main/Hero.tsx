        ...
        <div className="flex flex-col md:flex-row items-center">
          ...
          <div className="md:w-1/2 mb-10 md:mb-0">
            <h1 className="text-4xl md:text-5xl font-bold mb-4 text-gray-800">
              Xin chào, tôi là
              <span className="text-blue-600"> VÕ NHẬT HÀO</span>
            </h1>
            <h2 className="text-2xl md:text-3xl text-gray-600 mb-6">
              <TypingText
                texts={[
                  "Lập Trình Viên Website & Mobile App",
                  "Yêu thích Flutter & Python",
                  "Sống chết vì UI/UX 🎨",
                ]}
                speed={120}
                deleteSpeed={50}
            ...
            <div className="flex space-x-4">
              ...
              <a
                href="/VoNhatHao_CV_ThucTapSinhIT.pdf"
                // download
                target="_blank"
                rel="noopener noreferrer"
                className=" text-gray-400 px-6 py-3 rounded-lg hover:text-gray-700 transition"
              >
                Xem CV
              </a>
            </div>
